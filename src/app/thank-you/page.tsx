...
export const metadata: Metadata = {
  title: "Thank you",
  description: "We've received your message. A team member will reach out shortly.",
  alternates: regionalAlternates("global", "/thank-you"),
      ...
      <section className="min-h-[60vh] flex items-center bg-soft-premium">
        <div className="container-x py-20 md:py-24 max-w-xl text-center mx-auto">
          ...
          <p className="mt-5 text-lg text-ink-600 leading-relaxed">
            We've received your message{subject ? ` about "${subject}"` : ""}. A team member will reply within one business day.
          </p>
          {ticket && (
